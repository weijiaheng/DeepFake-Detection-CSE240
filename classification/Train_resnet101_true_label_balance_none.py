...
resnet_conv = ResNet101(weights=None, include_top=False, input_shape=(image_size, image_size, 3))
...
filepath = "current_best_weights_resnet101_true_label_balance.hdf5"
...
writer = csv.writer(open('results/Resnet101_train_with_true_label_none.csv','w'))
...
model.save('trained_models/Resnet101_train_with_true_label_none.h5')
