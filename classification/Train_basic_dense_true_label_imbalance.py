...
writer = csv.writer(open('results/basic_dense_train_with_true_label_imbalance.csv','w'))
...
model.save('trained_models/basic_dense_train_with_true_label_imbalance.h5')
