...
writer = csv.writer(open('results/VGG16_train_with_generated_label_imbalance.csv','w'))
...
model.save('trained_models/VGG16_train_with_generated_label_imbalance.h5')
