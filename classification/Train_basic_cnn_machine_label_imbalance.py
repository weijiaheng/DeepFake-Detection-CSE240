...
model.compile(loss='binary_crossentropy',optimizer=optimizers.RMSprop(learning_rate=0.0001, decay=1e-6), metrics=['acc'])
...
writer = csv.writer(open('results/basic_cnn_train_with_generated_label_imbalance.csv','w'))
...
model.save('trained_models/basic_cnn_train_with_generated_label_imbalance.h5')
