...
model.add(layers.Dense(64, activation='relu', input_shape=(image_size, image_size, 3)))
...
writer = csv.writer(open('results/basic_dense_train_with_generated_label_imbalance.csv','w'))
...
model.save('trained_models/basic_dense_train_with_generated_label_imbalance.h5')
