...
filepath = "current_best_weights_resnet50_true_label_balance.hdf5"
...
writer = csv.writer(open('results/Resnet50_train_with_true_label_none.csv','w'))
...
model.save('trained_models/Resnet50_train_with_true_label_none.h5')
